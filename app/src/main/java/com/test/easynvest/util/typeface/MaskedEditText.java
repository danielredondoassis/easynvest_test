...
/**
 *
 * Slightly modified from https://github.com/reinaldoarrosi/MaskedEditText/tree/master/MaskedEditText
 * to handle phone numbers, and not display useless chars at start
 */
public class MaskedEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public MaskedEditText(Context context, String mask, char placeholder) {
        this(context, null, mask, placeholder, 0);
    }
    ...
    public MaskedEditText(Context context, AttributeSet attr, String mask, char placeholder, int style) {
        ...
        for (int i = 0; i < N; ++i)
        {
            ...
            switch (at)
            {
                ...
                case R.styleable.MaskedEditText_placeholder:
                    ...
                    break;
                case R.styleable.MaskedEditText_is_phone:
                    is_phone = a.getBoolean(at, false);
                    break;
            }
        }
    ...
    public void isPhone(boolean is_phone) {
    ...
    private class MaskTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            if (updating || mask == null || mask.length() == 0)
                return;
